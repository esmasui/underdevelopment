...
import com.uphyca.android.support.lifecyclecallbacks.LifecycleCallbacksSupportFragmentActivity;
import com.uphyca.android.support.lifecyclecallbacks.test.LifecycleCallbacksSupportFragmentActivityTest.LifecycleCallbacksSupportFragmentActivityTestActivity;

/**
 * {@link ActivityLifecycleCallbacks} をICS以前でも使えるようにbackportした {@link ActivityLifecycleCallbacks} がオリジナルと同様の動作をすることを確認する
 */

public class LifecycleCallbacksSupportFragmentActivityTest extends ActivityUnitTestCase<LifecycleCallbacksSupportFragmentActivityTestActivity> {

    public static final class LifecycleCallbacksSupportFragmentActivityTestActivity extends LifecycleCallbacksSupportFragmentActivity {
    }

    public static final class LifecycleCallbacksSupportFragmentActivityTestApplication extends LifecycleCallbacksSupportApplication {
    }
    ...
    public LifecycleCallbacksSupportFragmentActivityTest() {
        super(LifecycleCallbacksSupportFragmentActivityTestActivity.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mApplication = new LifecycleCallbacksSupportFragmentActivityTestApplication();
